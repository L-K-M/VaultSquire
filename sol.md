...
- A global, system-wide Quick Search hotkey (current one is app-menu only;
  Settings already names it "In-app" honestly). Gated by
...
- **#72 — ⌘F** (focus search — needs `searchFocused`, macOS 15+), a shortcut
  for the one-time code, and a shortcut to open a website. *(#72)*
- **#72 — type-to-find in the item list**: focus the list, start typing,
  filter immediately, the way Finder behaves. *(#72)*
- **U4 / D2 — "Open and copy password" as one Quick Search action (⌘Return)**
  and ⌘⇧C to copy a result's password without opening it. *(U4, D2, #47)*
