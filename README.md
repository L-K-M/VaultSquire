...
24. [`docs/reviews/2026-08-12-consolidated-backlog.md`](docs/reviews/2026-08-12-consolidated-backlog.md):
    ...
    evidence).
25. [`docs/reviews/2026-08-13-working-backlog.md`](docs/reviews/2026-08-13-working-backlog.md):
    the live backlog — entry 24 merged with the sol review pass, with
    everything done since cleared out and traced to what closed it. Work from
    this one; entry 24 is its superseded predecessor (subordinate evidence).
26. [`docs/reviews/2026-08-12-sol-review.md`](docs/reviews/2026-08-12-sol-review.md):
    the 2026-08 sol review pass in full — status re-derived from
    `905d76d`/`f48084e`, the mid-pass #79 reconciliation, and the plan behind
    the `sol/*` pull requests (subordinate evidence).
